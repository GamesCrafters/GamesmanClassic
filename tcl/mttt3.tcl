...
proc NameFlash { c } {
    ...
    #"TIC"
    $c create text [expr 1 * $dotmid + $leftBuffer] [expr 1 * $dotmid + $topBuffer] -text "T" -font {Helvetica 100} -fill red -tags {ttic ttt}
    $c create text [expr 3 * $dotmid + $leftBuffer] [expr 1 * $dotmid + $topBuffer] -text "I" -font {Helvetica 100} -fill red -tags {itic ttt}
    $c create text [expr 5 * $dotmid + $leftBuffer] [expr 1 * $dotmid + $topBuffer] -text "C" -font {Helvetica 100} -fill red -tags {ctic ttt}
    
    #"TAC"
    $c create text [expr 1 * $dotmid + $leftBuffer] [expr 3 * $dotmid + $topBuffer] -text "T" -font {Helvetica 100} -fill green -tags {ttac ttt}
    $c create text [expr 3 * $dotmid + $leftBuffer] [expr 3 * $dotmid + $topBuffer] -text "A" -font {Helvetica 100} -fill green -tags {atac ttt}
    $c create text [expr 5 * $dotmid + $leftBuffer] [expr 3 * $dotmid + $topBuffer] -text "C" -font {Helvetica 100} -fill green -tags {ctac ttt}


    #"TOE"
    $c create text [expr 1 * $dotmid + $leftBuffer] [expr 5 * $dotmid + $topBuffer] -text "T" -font {Helvetica 100} -fill blue -tags {ttoe ttt}
    $c create text [expr 3 * $dotmid + $leftBuffer] [expr 5 * $dotmid + $topBuffer] -text "O" -font {Helvetica 100} -fill blue -tags {otoe ttt}
    $c create text [expr 5 * $dotmid + $leftBuffer] [expr 5 * $dotmid + $topBuffer] -text "E" -font {Helvetica 100} -fill blue -tags {etoe ttt}
