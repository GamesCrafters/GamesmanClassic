...
CONST_STRING   kGameName           = "Connections";
...
CONST_STRING   kHelpOnYourTurn = "No help";

CONST_STRING   kHelpStandardObjective = "No help";

CONST_STRING   kHelpReverseObjective = "No help";
...
XYtoPos(ClientData dummy,Tcl_Interp *interp, int argc, char** argv)
{
  ...
  if (argc != 3) {
    char result[] = "wrong # args: Scored (int)x (int)y";
