 ...
 **                   turn (0 and 1 at msg, m		if (piece == BLUEBUCKETPIECE) { blueB++; }
...
void InitializeGame ()
{
  ...
  */
  ...
  //int game[16] = {HASHBLANK, 5, 9, HASHSANDPILE, 0, 4, HASHSANDPILE, 0, 4, HASHREDBUCKET, 0, 2, HASHBLUEBUCKET, 0, 2, -1};
  //generic_hash_init(boardSize, game, NULL, 0);
...
void SetupTierStuff() {
  ...
  int tier = 0, b = 0, r = 0;
  int numberofblanks;
  /** The total tier positions is: (5 values for Large piece)*(5 values for Small piece)*(3 values for Blue bucket)*(3 values for Red bucket)=225**/
  int TOTALTIERPOSITIONS = 225;
  int tempHash = 0;
  int maxL = 0;
  int maxS = 0;
  int maxB = 0;
  /* int piecesArray[] = {HASHBLANK, 0, 9, HASHSANDPILE, 0, 4, HASHSANDPILE, 0, 4, HASHREDBUCKET, 0, 2, HASHBLUEBUCKET, 0, 2, -1};   */
  int LpiecesArray[] = { HASHBLANK, 5, 9, HASHSANDPILE, 0, 4, -1 };
  int SpiecesArray[] = { HASHBLANK, 5, 9, HASHSANDPILE, 0, 4, -1 };
  int BpiecesArray[] = { HASHBLANK, 5, 9, HASHREDBUCKET, 0, 2, HASHBLUEBUCKET, 0, 2, -1 };
  ...
  for(; tier < TOTALTIERPOSITIONS; tier++) { // 12 total pieces - 4 large, 4 small, 2 redB, 2blueB
    // tier = buckets + 9*small + 45*large
    LpiecesArray[1] = 9 - (tier / 45); //5
    LpiecesArray[2] = 9 - (tier / 45);
    LpiecesArray[4] = (tier / 45); //0
    ...
    /* piecesArray[1] = 9 - (tier / 45); */
    /* piecesArray[2] = 9 - (tier / 45); */
    /* piecesArray[4] = (tier/ 45); */
    /* piecesArray[5] = (tier / 45); */
    /* piecesArray[7] = ((tier % 45) / 9); */
    /* piecesArray[8] = ((tier % 45) / 9); */
    ...
    //numberofblanks = 9-b-r-(tier/45)-(tier % 45) / 9;

    /* LpiecesArray[1] = numberofblanks; */
    /* LpiecesArray[2] = numberofblanks; */
    /* SpiecesArray[1] = numberofblanks; */
    /* SpiecesArray[2] = numberofblanks; */
    /* BpiecesArray[1] = numberofblanks; */
    /* BpiecesArray[2] = numberofblanks; */

    /* piecesArray[1] = numberofblanks; */
    /* piecesArray[2] = numberofblanks; */
    /* piecesArray[4] = piecesArray[5] = (tier/45); */
    /* piecesArray[7] = piecesArray[8] = (tier % 45)/9; */
    /* piecesArray[9] = piecesArray[10] = r; */
    /* piecesArray[12] = piecesArray[13] = b; */

    printf("LpiecesArray[1]: %d\n", LpiecesArray[1]);
    printf("LpiecesArray[2]: %d\n", LpiecesArray[2]);
    printf("LpiecesArray[4]: %d\n", LpiecesArray[4]);
    printf("LpiecesArray[5]: %d\n", LpiecesArray[5]);
		
    printf("SpiecesArray[1]: %d\n", SpiecesArray[1]);
    printf("SpiecesArray[2]: %d\n", SpiecesArray[2]);
    printf("SpiecesArray[4]: %d\n", SpiecesArray[4]);
    printf("SpiecesArray[5]: %d\n", SpiecesArray[5]);

    printf("BpiecesArray[1]: %d\n", BpiecesArray[1]);
    printf("BpiecesArray[2]: %d\n", BpiecesArray[2]);
    printf("BpiecesArray[4]: %d\n", BpiecesArray[4]);
    printf("BpiecesArray[5]: %d\n", BpiecesArray[5]);
    printf("BpiecesArray[7]: %d\n", BpiecesArray[7]);
    printf("BpiecesArray[8]: %d\n", BpiecesArray[8]);
		

    /* printf("piecesArray[1]: %d\n", piecesArray[1]); */
    /* printf("piecesArray[4]: %d\n", piecesArray[4]); */
    /* printf("piecesArray[7]: %d\n", piecesArray[7]); */
    /* printf("piecesArray[9]: %d\n", piecesArray[9]); */
    /* printf("piecesArray[10]: %d\n", piecesArray[12]); */

	
    maxL = generic_hash_init(boardSize, LpiecesArray, NULL, 0);
    generic_hash_set_context(tier*3);

    //maxS = generic_hash_init(boardSize, LpiecesArray, NULL, 0);
    //generic_hash_set_context(tier*3 + 1);

    
    // maxB = generic_hash_init(boardSize, LpiecesArray, NULL, 0);
    //generic_hash_set_context(tier*3 + 2);
  ...
  gNumberOfPositions = &NumberOfTierPositions;//NumberOfTierPositions(gInitialTier); // ?
