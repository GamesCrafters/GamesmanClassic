...
proc GS_InitGameSpecific {} {
    ...
    set kStandardString "First player to occupy the whole board WINS"
    set kMisereString "First player to occupy the whole board  LOSES"
    ...
    global gMisereGame
    if {!$gMisereGame} {
	SetToWinString "To Win: Be the first player to occupy the board with your color."
    } else {
	SetToWinString "To Win: Force your opponent to occupy each square."
    }
    SetToMoveString "To Move: Players alternate turns placing pieces into any box that does not contain the opponent's color. If the box fills up, then it will explode and all the pieces, except for one,  are distributed to the surrounding boxes. If one of the surrounding boxes is occupied by the opponent, it is captured and taken over by your color. Multiple explosions may occur if the previous explosion caused other spaces to reach critical mass. Select an empty square to place a piece or  to add a square of your color."
	    
    # Authors Info. Change if desired
    global kRootDir
    global kCAuthors kTclAuthors kGifAuthors
    set kCAuthors "Peterson Trethewey"
    set kTclAuthors "David Chan, Peterson Trethewey"
