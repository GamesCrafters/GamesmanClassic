...
proc DoComputersMove {} {
    ...
    set makecomputergoagain 0

    if {[C_GoAgain $oldposition $theMove]} {
	    set makecomputergoagain 1
    } else {
...
proc HandleMove { theMove } {
    ...
    set wegoagain 0
    if {[C_GoAgain $gPosition $theMoveForTheCProc]} {
	set wegoagain 1
    } else {
	set gPlayerOneTurn [not $gPlayerOneTurn]
    }
