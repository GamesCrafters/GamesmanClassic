...
proc DoComputersMove {} {
	...
	##ADDED FOR SHIFT TAC TOE, SINCE IT NEEDS TO KNOW THE FINAL POSITION

	set theSlot [C_DoMove $gPosition $theMove]
...
proc HandleMove { theMove } {
    ...
    #puts "HandleMove THEMOVE: $theMove"
	...
	###### ADDED FOR SHIFT TAC TOE SINCE IT NEEDS TO KNOW THE NEW BOARD CONFIGURATION

	set tempMove [GS_ConvertInteractionToMove $theMove]
	set theSlot [C_DoMove $gPosition $tempMove]
