...
**
** UPDATE HIST:
** 02/02/2005 Updated game-specific constants.
...
POSITION gNumberOfPositions   =  81; /* The number of total possible positions | If you are using our hash, this is given by the hash_init() function*/
