...
by 1 or 2 points. The winner is the first person to raise the total sum to N.  If at any point you have \n\
made a mistake, type u to revert back to your previous position.";

STRING   kHelpOnYourTurn =
"Select the number 1 or 2 to raise the total sum. You can also revert to the previous position by typing u.";
